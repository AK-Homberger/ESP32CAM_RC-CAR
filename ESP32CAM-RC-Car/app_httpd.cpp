      ...
      <div id="stream-container" class="image-container hidden">
        ...
        <section class="main">
            <section id="buttons">
                ...
                <tr><td>Speed</td><td align="center" colspan="2"><input type="range" id="speed" min="0" max="255" value="128" onchange="try{fetch(document.location.origin+'/control?var=speed&val='+this.value);}catch(e){}"></td></tr>
                <tr><td>Servo</td><td align="center" colspan="2"><input type="range" id="servo" min="450" max="600" value="520" onchange="try{fetch(document.location.origin+'/control?var=servo&val='+this.value);}catch(e){}"></td></tr>
